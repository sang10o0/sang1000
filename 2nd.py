...
ROCK_IMAGES = [IMAGE_PATH + f"rock{i:02d}.png" for i in range(1, 31)]
...
def write_text(text, font, size, color, x, y):
    """텍스트를 화면에 씁니다."""
...
def is_collision(obj1_x, obj1_y, obj1_width, obj1_height, obj2_x, obj2_y, obj2_width, obj2_height):
    ...
    if (obj1_x < obj2_x + obj2_width and obj1_x + obj1_width > obj2_x and
